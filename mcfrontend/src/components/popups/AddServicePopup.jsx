...
export default function AddServicePopup({ onClose, onAdd }) {
            ...
            <div className="bg-white rounded-2xl border border-slate-200 w-full max-w-md shadow-2xl animate-in fade-in zoom-in duration-200">
                <div className="flex items-center justify-between p-6 border-b border-slate-100 bg-slate-50/50">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-xl font-black text-slate-900 leading-none mb-1">Add New Service</h2>
                            <p className="text-slate-500 text-[10px] font-medium uppercase tracking-wider">Configure hospital healthcare provision</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <div className="space-y-1.5">
                        ...
                        <input
                            type="text"
                            required
                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-800 placeholder-slate-400 focus:outline-none focus:border-[#1c6b64] transition-all"
                    ...
                    <div className="space-y-1.5">
                        ...
                        <textarea
                            required
                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-800 placeholder-slate-400 focus:outline-none focus:border-[#1c6b64] h-24 resize-none transition-all"
